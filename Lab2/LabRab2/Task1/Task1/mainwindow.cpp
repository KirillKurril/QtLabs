...
void MainWindow::on_openFileButton_clicked(bool firstTime = 0)
{
    ...
    if(!firstTime) fileAdress = QFileDialog::getOpenFileName(this, "Открыть файл", "C:/Users/dzmitry/source/repos/2semestr/LabRab2/Task1/Task1", "Text files (*.txt)");
