...
{
DPair<QString, QString> p1("1", "2");
DPair<QString, QString> p2("3", "4");
DPair<DPair<QString, QString>, DPair<QString, QString>> pp(p1, p2);
DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>> v;
v.push_back(pp);
DVector <DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>>> vv;
vv.push_back(v);
DVector <DVector <DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>>>> vvv;
vvv.push_back(vv);


qDebug()<<vvv[0][0][0].first.first << " " << vvv[0][0][0].first.second << " " << vvv[0][0][0].second.first << " " << vvv[0][0][0].second.second << '\n';

DPair<QString, QString> p1_("5", "6");
DPair<QString, QString> p2_("7", "8");
DPair<DPair<QString, QString>, DPair<QString, QString>> pp_(p1_, p2_);
DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>> v_;
v_.push_back(pp_);
DVector <DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>>> vv_;
vv_.push_back(v_);
vvv.push_back(vv_);
qDebug()<<vvv[1][0][0].first.first << " " << vvv[1][0][0].first.second << " " << vvv[1][0][0].second.first << " " << vvv[1][0][0].second.second << '\n';

DPair<QString, QString> p1__("9", "10");
DPair<QString, QString> p2__("11", "12");
DPair<DPair<QString, QString>, DPair<QString, QString>> pp__(p1__, p2__);
DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>> v__;
v__.push_back(pp__);
DVector <DVector<DPair<DPair<QString, QString>, DPair<QString, QString>>>> vv__;
vv__.push_back(v__);
vvv.push_back(vv__);
qDebug()<<vvv[2][0][0].first.first << " " << vvv[2][0][0].first.second << " " << vvv[2][0][0].second.first << " " << vvv[2][0][0].second.second << '\n';
